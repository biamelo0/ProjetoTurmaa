...
import com.example.ProjetoVendass.entities.Aluno;
import com.example.ProjetoVendass.repository.AlunoRepository; 
...
public class AlunoService { 
	...
	public Aluno alteraAluno(long id, Aluno alteraAluno) {  

		Optional <Aluno> existeAluno = alunoRepository.findById(id);  

		if (existeAluno.isPresent()) {  

			alteraAluno.setId(id);  

			return alunoRepository.save(alteraAluno);  
